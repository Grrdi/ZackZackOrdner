...
; Das ändert sich voraussichlich wenn die Sucheinstellungen, die zum Inhalt von Edit8 führen, mit Historisiert werden.
	...
	; if(InStr(Edit8,A_Tab . A_Tab))		; vorhandenes Explorerfenster erkennen
{
	...
	; ThisWinHwnd:=SubStr(Edit8,EckKlammerZuPos+2)
	DieserPfadHwnd:=Decimal_to_Hex(SubStr(Edit8,EckKlammerZuPos+2))
	; MsgBox % DieserPfadHwnd "	" SubStr(Edit8,EckKlammerZuPos+2) "	" EckKlammerZuPos
...
; 	ThisNewFavorit=Name|*Pfad
					LV_Insert(1,"",PfadAngekommenZaehler,DieserPfadHwnd,ThisCacheName,"","","","","",DieserTyp,FuehrendeSterneEntfernen(Edit8), "","","","","","","","","","","","")
